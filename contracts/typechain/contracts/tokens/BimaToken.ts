...
export interface BimaTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface BimaToken extends BaseContract {
  connect(runner?: ContractRunner | null): BimaToken;
  waitForDeployment(): Promise<this>;

  interface: BimaTokenInterface;
